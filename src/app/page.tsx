    ...
    <div className="grid min-h-screen grid-rows-[20px_1fr_20px] items-center justify-items-center gap-16 p-8 pb-20 font-sans sm:p-20">
      <main className="row-start-2 flex flex-col items-center gap-[32px] sm:items-start">
        ...
        <div className="w-full max-w-md">
          <h2 className="mb-4 text-center text-xl font-semibold text-gray-500 sm:text-left">
            Try the Search with Autocomplete
          </h2>
          <SearchInput />
          <p className="mt-2 text-center text-sm text-gray-500 sm:text-left">
            Start typing to see autocomplete suggestions. Click on any suggestion to navigate to a
            dynamic page.
          </p>
        </div>
